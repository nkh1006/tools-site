...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: "SeverancePage" });
  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    alternates: {
      languages: {
        ko: "/severance-calculator",
        en: "/en/severance-calculator",
      },
    },
  };
}
...
export default async function SeveranceCalculatorPage({
  ...
  const t = await getTranslations("SeverancePage");
